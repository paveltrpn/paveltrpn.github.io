!(function (n) {
  ...
  function (t, e, n) {
    ...
    var a = n(4),
      ...
      u = n(9),
      p = {};
    (p.Macro = r.default.Macro),
      (p.xArrow = c.default.xArrow),
      (p.Machine = function (t, e, n) {
        try {
          var a = t.GetArgument(e),
            o = u.mhchemParser.go(a, n),
            r = u.texify.go(o);
          (t.string = r + t.string.substr(t.i)), (t.i = 0);
        } catch (t) {
  ...
  function (t, e, n) {
    ...
    var m = {
      go: function (t, e) {
        ...
        for (var r = 10, i = []; ; ) {
          n !== t ? ((r = 10), (n = t)) : r--;
          var c = m.stateMachines[e],
            u = c.transitions[a] || c.transitions["*"];
          t: for (var p = 0; p < u.length; p++) {
            var s = m.patterns.match_(u[p].pattern, t);
            if (s) {
              for (var _ = u[p].task, l = 0; l < _.action_.length; l++) {
                var d;
                if (c.actions[_.action_[l].type_])
                  d = c.actions[_.action_[l].type_](
                    o,
                    s.match_,
                    _.action_[l].option
                  );
                else {
                  if (!m.actions[_.action_[l].type_])
                    throw [
                      "MhchemBugA",
              ...
              if (((a = _.nextState || a), !(0 < t.length))) return i;
              if ((_.revisit || (t = s.remainder), !_.toContinue)) break t;
            }
          }
      ...
      patterns: {
        patterns: {
          ...
          "state of aggregation $": function (t) {
            var e = m.patterns.findObserveGroups(
              t,
              "",
              /^\([a-z]{1,3}(?=[\),])/,
              ")",
          ...
          "* ": /^([*])\s*/,
          "^{(...)}": function (t) {
            return m.patterns.findObserveGroups(t, "^{", "", "", "}");
          },
          "^($...$)": function (t) {
            return m.patterns.findObserveGroups(t, "^", "$", "$", "");
          },
          "^a": /^\^([0-9]+|[^\\_])/,
          "^\\x{}{}": function (t) {
            return m.patterns.findObserveGroups(
              t,
              "^",
              /^\\[a-zA-Z]+\{/,
              "}",
          ...
          "'": /^'/,
          "_{(...)}": function (t) {
            return m.patterns.findObserveGroups(t, "_{", "", "", "}");
          },
          "_($...$)": function (t) {
            return m.patterns.findObserveGroups(t, "_", "$", "$", "");
          },
          ...
          arrowUpDown: /^(?:v|\(v\)|\^|\(\^\))(?=$|[\s,;\)\]\}])/,
          "\\bond{(...)}": function (t) {
            return m.patterns.findObserveGroups(t, "\\bond{", "", "", "}");
          },
          "->": /^(?:<->|<-->|->|<-|<=>>|<<=>|<=>|[\u2192\u27F6\u21CC])/,
          CMT: /^[CMT](?=\[)/,
          "[(...)]": function (t) {
          ...
          "\\color{(...)}0": function (t) {
            return m.patterns.findObserveGroups(t, "\\color{", "", "", "}");
          },
          "\\color{(...)}{(...)}1": function (t) {
            return m.patterns.findObserveGroups(
              t,
          ...
          "\\ce{(...)}": function (t) {
            return m.patterns.findObserveGroups(t, "\\ce{", "", "", "}");
          },
          ...
          amount: function (t) {
            ...
            var n = m.patterns.findObserveGroups(t, "", "$", "$", "");
            return n &&
              (e = n.match_.match(
        ...
        findObserveGroups: function (t, e, n, a, o, r, i, c, u, p) {
          function s(t, e) {
          ...
          var d = t.substring(0, a ? l.endMatchEnd : l.endMatchBegin);
          if (r || i) {
            var m = this.findObserveGroups(t.substr(l.endMatchEnd), r, i, c, u);
            if (null === m) return null;
            var h = [d, m.match_];
            return { match_: p ? h.join("") : h, remainder: m.remainder };
          }
          return { match_: d, remainder: t.substr(l.endMatchEnd) };
        },
        match_: function (t, e) {
          var n = m.patterns.patterns[t];
          if (void 0 === n)
            throw ["MhchemBugP", "mhchem bug P. Please report. (" + t + ")"];
          if ("function" == typeof n) return m.patterns.patterns[t](e);
          var a = e.match(n);
          return a
            ? {
      ...
      actions: {
        ...
        "{text}": function (t, e) {
          var n = ["{"];
          return m.concatArray(n, m.go(e, "text")), n.push("}"), n;
        },
        "tex-math": function (t, e) {
          return m.go(e, "tex-math");
        },
        "tex-math tight": function (t, e) {
          return m.go(e, "tex-math tight");
        },
        bond: function (t, e, n) {
      ...
      createTransitions: function (t) {
        ...
        for (e in t)
          for (n in t[e])
            for (
              a = n.split("|"), t[e][n].stateArray = a, o = 0;
              o < a.length;
              o++
            )
              r[a[o]] = [];
        for (e in t)
          for (n in t[e])
            for (a = t[e][n].stateArray || [], o = 0; o < a.length; o++) {
              var i = t[e][n];
              if (i.action_) {
              ...
              for (var u = e.split("|"), p = 0; p < u.length; p++)
                ...
                else r[a[o]].push({ pattern: u[p], task: i });
            }
        return r;
      },
      stateMachines: {},
    ...
    m.stateMachines = {
      ce: {
        transitions: m.createTransitions({
        ...
        actions: {
          "o after d": function (t, e) {
            ...
            if ((t.d || "").match(/^[0-9]+$/)) {
              var a = t.d;
              (t.d = void 0), (n = this.output(t)), (t.b = a);
            } else n = this.output(t);
            return m.actions["o="](t, e), n;
          },
          "d= kv": function (t, e) {
            (t.d = e), (t.dType = "kv");
          },
          "charge or bond": function (t, e) {
            if (t.beginsWithBond) {
              var n = [];
              return (
                m.concatArray(n, this.output(t)),
                m.concatArray(n, m.actions.bond(t, e, "-")),
                n
              );
            }
            t.d = e;
          ...
          "- after o/d": function (t, e, n) {
            var a = m.patterns.match_("orbital", t.o || ""),
              o = m.patterns.match_("one lowercase greek letter $", t.o || ""),
              r = m.patterns.match_("one lowercase latin letter $", t.o || ""),
              i = m.patterns.match_(
                "$one lowercase latin letter$ $",
                t.o || ""
              ),
              c = "-" === e && ((a && "" === a.remainder) || o || r || i);
            !c ||
              t.a ||
              t.b ||
              t.p ||
            ...
            return (
              c
                ? (m.concatArray(u, this.output(t)),
                  u.push({ type_: "hyphen" }))
                : ((a = m.patterns.match_("digits", t.d || "")),
                  n && a && "" === a.remainder
                    ? (m.concatArray(u, m.actions["d="](t, e)),
                      m.concatArray(u, this.output(t)))
                    : (m.concatArray(u, this.output(t)),
                      m.concatArray(u, m.actions.bond(t, e, "-")))),
              u
            );
          },
          "a to o": function (t) {
          ...
          "state of aggregation": function (t, e) {
            return { type_: "state of aggregation", p1: m.go(e, "o") };
          },
          comma: function (t, e) {
            var n = e.replace(/\s*$/, "");
                ...
                (t.a || t.b || t.p || t.o || t.q || t.d || n) &&
                  ...
                  t.o || t.q || t.d || t.b || t.p || 2 === n
                    ? t.o || t.q || t.d || (!t.b && !t.p)
                      ? t.o &&
                        "kv" === t.dType &&
                        m.patterns.match_("d-oxidation$", t.d || "")
                        ? (t.dType = "oxidation")
                  ...
                  a.push({
                    ...
                    o: m.go(t.o, "o"),
                    q: m.go(t.q, "pq"),
                    d: m.go(t.d, "oxidation" === t.dType ? "oxidation" : "bd"),
                    dType: t.dType,
                  })));
            for (var i in t)
          ...
          "oxidation-output": function (t, e) {
            var n = ["{"];
            return m.concatArray(n, m.go(e, "oxidation")), n.push("}"), n;
          },
          "frac-output": function (t, e) {
            return { type_: "frac-ce", p1: m.go(e[0]), p2: m.go(e[1]) };
          },
          "overset-output": function (t, e) {
            return { type_: "overset", p1: m.go(e[0]), p2: m.go(e[1]) };
          },
          "underset-output": function (t, e) {
            return { type_: "underset", p1: m.go(e[0]), p2: m.go(e[1]) };
          },
          "underbrace-output": function (t, e) {
            return { type_: "underbrace", p1: m.go(e[0]), p2: m.go(e[1]) };
          },
          "color-output": function (t, e) {
            return { type_: "color", color1: e[0], color2: m.go(e[1]) };
          },
          "r=": function (t, e) {
            t.r = e;
          },
      ...
      pq: {
        ...
        actions: {
          ...
          "color-output": function (t, e) {
            return { type_: "color", color1: e[0], color2: m.go(e[1], "pq") };
          },
        },
      },
      bd: {
        ...
        actions: {
          "color-output": function (t, e) {
            return { type_: "color", color1: e[0], color2: m.go(e[1], "bd") };
          },
        },
      },
      oxidation: {
      ...
      pu: {
        ...
        actions: {
          enumber: function (t, e) {
            ...
            return (
              "+-" === e[0] || "+/-" === e[0]
                ...
                : e[0] && n.push(e[0]),
              e[1] &&
                (m.concatArray(n, m.go(e[1], "pu-9,9")),
                e[2] &&
                  (e[2].match(/[,.]/)
                    ? m.concatArray(n, m.go(e[2], "pu-9,9"))
                    : n.push(e[2])),
                (e[3] = e[4] || e[3]),
                e[3] &&
                  ((e[3] = e[3].trim()),
          ...
          output: function (t) {
            var e,
              n = m.patterns.match_("{(...)}", t.d || "");
            n && "" === n.remainder && (t.d = n.match_);
            var a = m.patterns.match_("{(...)}", t.q || "");
            if (
              ...
              var o = { d: m.go(t.d, "pu"), q: m.go(t.q, "pu") };
              "//" === t.o
                ? (e = { type_: "pu-frac", p1: o.d, p2: o.q })
                : (1 < (e = o.d).length || 1 < o.q.length
                    ? e.push({ type_: " / " })
                    : e.push({ type_: "/" }),
                  m.concatArray(e, o.q));
            } else e = m.go(t.d, "pu-2");
      ...
      "pu-9,9": {
        ...
        actions: {
          ...
          "output-o": function (t) {
            var e = [];
            if (((t.text_ = t.text_ || ""), 4 < t.text_.length)) {
              for (var n = t.text_.length - 3, a = 0; a < n; a += 3)
                e.push(t.text_.substr(a, 3)),
                  e.push({ type_: "1000 separator" });
    ...
    var u = {
      go: function (t, e) {
        ...
        for (var n = "", a = !1, o = 0; o < t.length; o++) {
          ...
          "string" == typeof r
            ? (n += r)
            : ((n += u._go2(r)), "1st-level escape" === r.type_ && (a = !0));
        }
        return e || a || !n || (n = "{" + n + "}"), n;
      },
      _goInner: function (t) {
      ...
      _go2: function (t) {
        ...
        switch (t.type_) {
          case "chemfive":
            ...
            n.a &&
              ...
              (n.b || n.p) &&
                ...
                (e += "{\\vphantom{X}}"),
                (e +=
                  "^{\\smash[t]{\\vphantom{2}}\\llap{" + (n.b || "") + "}}"),
                (e +=
                  "_{\\vphantom{2}\\llap{\\smash[t]{" + (n.p || "") + "}}}")),
              n.o &&
          ...
          case "state of aggregation":
            e = "\\mskip2mu " + u._goInner(t.p1);
            break;
          case "state of aggregation subscript":
            e = "\\mskip1mu " + u._goInner(t.p1);
            break;
          case "bond":
            if (!(e = u._getBond(t.kind_)))
              throw [
                "MhchemErrorBond",
          ...
          case "pu-frac":
            var o =
              "\\frac{" + u._goInner(t.p1) + "}{" + u._goInner(t.p2) + "}";
            e =
              "\\mathchoice{\\textstyle" +
              o +
              "}{" +
          ...
          case "tex-math":
            ...
            break;
          case "frac-ce":
            e = "\\frac{" + u._goInner(t.p1) + "}{" + u._goInner(t.p2) + "}";
            break;
          case "overset":
            e = "\\overset{" + u._goInner(t.p1) + "}{" + u._goInner(t.p2) + "}";
            break;
          case "underset":
            e =
              "\\underset{" + u._goInner(t.p1) + "}{" + u._goInner(t.p2) + "}";
            break;
          case "underbrace":
            e =
              "\\underbrace{" +
            ...
            break;
          case "color":
            e = "{\\color{" + t.color1 + "}{" + u._goInner(t.color2) + "}}";
            break;
          case "color0":
            e = "\\color{" + t.color + "}";
            break;
          case "arrow":
            var r = u._goInner(t.rd),
              i = u._goInner(t.rq),
              c = u._getArrow(t.r);
            e = c =
              r || i
